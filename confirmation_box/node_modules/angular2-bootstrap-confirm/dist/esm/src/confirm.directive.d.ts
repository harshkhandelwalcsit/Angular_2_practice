...
import { ConfirmOptions } from './confirmOptions.provider';
 ...
 * ```
 */
export declare class Confirm implements OnDestroy, OnChanges, OnInit {
     ...
     * @private
     */
    popover: ComponentRef<ConfirmPopover>;
    /**
     * @private
     */
